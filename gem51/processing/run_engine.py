...
stream_path= str(pp)+"/load/stream/"
spec_path=str(pp)+"/load/spec/"
...
#	gem5= "/home/muneeb/base-environment/gem5/build/X86/gem5.opt  "
	config= "../run.sh  "
	subprocess.call(  config+ load_path, shell=True)
	new_name="./m5out/"+dir1+"_stats.txt";
	os.rename("./m5out/stats.txt",new_name)
'''
